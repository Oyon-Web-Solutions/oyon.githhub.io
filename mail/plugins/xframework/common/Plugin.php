...
define("XFRAMEWORK_VERSION", "1.7.2");
...
abstract class Plugin extends \rcube_plugin
{
    ...
    public function init()
    {
        ...
        $this->userLanguage = substr($this->rcmail->user->data['language'], 0, 2);
     ...
     * @return bool
     */
    protected function saveSetting(&$arg, $name, $type = false, $plugin = false, $allowedValues = null)
    {
        $plugin || $plugin = $this->plugin;
